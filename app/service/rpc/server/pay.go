...
//}
//
//func (s *PayServer) Pay(ctx context.Context, in *pb.BookRequest) (*pb.BookReply, error) {
//	var code int64 = 0
//
//	return &pb.BookReply{
//		Code: code,
...
//}
//
//func (s *PayServer) Refund(ctx context.Context, in *pb.RefundRequest) (*pb.RefundReply, error) {
//	var code int64 = 0
//
